            ...
            <table>
                ...
                <tbody>
                    <tr v-for="item in transactions" :key="item.id" v-bind:class="(item.amount < 0) ? 'expense' : 'income'">
                        ...
                        <td>
                            <router-link :to="{ name: 'EditExpenses', params: { id: item.id, type: item.amount < 0 ? 'expense' : 'income'}}">
                            ...
                            <router-link :to="{ name: 'DetailsExpenses', params: { id: item.id}}">
                            ...
                            <router-link :to="{ name: 'DeleteExpenses', params: { id: item.id}}">
